...
var userAgent = navigator.userAgent;
appInfo = new Array();
var parseString = userAgent;
var numInfo = 0;
var tmpInfo;
appInfo[numInfo++] = parseString;
while ((tmpInfo = parseString.match( /\s*([^()]*\s*\([^()]*\))\s*(.*)\s*$/ )) != null)
{
appInfo[numInfo++] = tmpInfo[1];
parseString = tmpInfo[2];
}
appInfo[numInfo++] = parseString;
var part = appInfo[1].match( /^\s*(.*)\s*\((.*)\)\s*$/ );
var part0 = part[1].split( "/" );
var part1 = part[2].split( ";" );
var part2 = appInfo[appInfo.length-1].split( " " );
this._userAgent.appName = navigator.appName;
this._userAgent.appCodeName = part0[0];
this._userAgent.appVersion = part0[1];
this._userAgent.appAttributes = part1;
...
var matchResult = prop.match( /MSIE (.*)/i );
if( matchResult )
{
...
this._infoObject.iconImageClickedEvent.Add( Delegate( this, InformationWidget.prototype._OpenHelpUrl ) );
...
InformationWidget.prototype.ShowInformation = function( infoString, helpUrl )
{
if( infoString == null || helpUrl == "" )
{
helpUrl = null;
}
...
InformationWidget.prototype._OpenHelpUrl = function()
{
...
this.codecMissingEvent = new Event();
this.codecDownloadedEvent = new Event();
...
this.infoEvent( 0xc00d11c8, this._codecState.wmvFileName );
}
...
this.codecMissingEvent( this._targetUri.value );
}
...
WmvErrorHandler.IsCodecMissingError = function( errorCode )
{
return errorCode == 0xc00d11c8;
}
...
this.gradedInfo = new GradedInfo( "" );
...
RenderingSession.prototype.SetInformation = function( level, info )
{
this.gradedInfo.SetInformation( level, info );
}
...
this._fitMargin = {Left:0,Top:UISettings.dataPaneInfoWidgetHeight,Right:0,Bottom:0};
...
if( renderer.fitMargin )
{
fitter.Bind( this, renderer, renderer.fitStyle,
renderer.fitMargin.Left,renderer.fitMargin.Top,renderer.fitMargin.Right,renderer.fitMargin.Bottom);
}
else
{
fitter.Bind( this, renderer, renderer.fitStyle );
...
var width = this.GetClientWidth();
var height = UISettings.dataPaneInfoWidgetHeight;
this._backgroundWidget.SetUIPosition( true, 0, 0, width, UISettings.dataPaneInfoWidgetHeight );
}
...
var show = this._informationWidget.IsShown();
if( show )
{
this._activeRenderer.fitMargin = this._fitMargin;
this._backgroundWidget.SetStyle("visibility","inherit");
}
else
{
this._activeRenderer.fitMargin = null;
this._backgroundWidget.SetStyle("visibility","hidden");
}
this._ResizeActiveRenderer();
}
...
this._RegisterCodecMissingEvent( qcifWmvWidget, "QCIFVideo" );
var panoWmvWidget = this._renderers[ "PanoVideo" ];
this._RegisterCodecMissingEvent( panoWmvWidget, "PanoVideo" );
var mmcWmvWidget = this._renderers[ "MMC" ].GetWidget(UISettings.mmcWmvWidgetId);
this._RegisterCodecMissingEvent( mmcWmvWidget, "MMC" );
var asWmvWidget = this._renderers[ "AppSharing" ].GetWidget(UISettings.asWmvWidgetId);
this._RegisterCodecMissingEvent( asWmvWidget, "AppSharing" );
}
UIObjects.prototype._RegisterCodecMissingEvent = function( wmvWidget, widgetName )
{
if( wmvWidget != null )
{
wmvWidget.codecMissingEvent.Add( DelegateWithArgs( this, UIObjects.prototype._OnCodecMissing, widgetName ) );
wmvWidget.codecDownloadedEvent.Add( DelegateWithArgs( this, UIObjects.prototype._OnCodecDownloaded, widgetName ) );
}
}
...
UIObjects.prototype._OnCodecMissing = function( wmvWidgetName, wmvFileName )
{
...
UIObjects.prototype._OnCodecDownloaded = function( wmvWidgetName )
{
...
ItemDownloader.prototype._StartLoadPage = function()
{
this._timerHandler = null;
...
DelegateWithArgs( this, ItemDownloader.prototype._JobTimeout, xmlhttp ),
estimateTime
);
}
}
...
{
this._timerHandler = setTimeout(
Delegate( this, ItemDownloader.prototype._StartLoadPage ),
jobInterval );
}
}
...
ItemDownloader.prototype._JobTimeout = function( xmlhttp )
{
var page = this._contentList[this._currentContent].page;
var job = page.jobList[page.currentJob];
if ( job.loaded == ItemDownloader.Pending )
...
this._timerHandler = setTimeout( Delegate( this, ItemDownloader.prototype._StartLoadPage ), 0 );
}
}
